...
Specialists online:
  ...
  Phase 6 — Intake (Gmail/Drive), Reporting (weekly digest)
"""
...
_SUPERVISOR_INSTRUCTION = (
    ...
    "output to the next stage. Do NOT do extraction yourself — delegate it.\n"
    "\n"
...
_SUB_AGENTS = [extraction_agent]  # noqa: N806
